...
import { WALLET_PRIVATE_KEY, RPC_URL, CHAIN_ID, VOLTA_CACHE_SERVER_URL, getInfuraIPFSConfig } from "./constants.js"
...
const createInitialIndex = async () => {
  ...
  const newIndexCID = await createInitialIndexFile(web3Storage, process.env.INDEX_FILE_NAME, iamClient.did, false)
